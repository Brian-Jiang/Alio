...
public class GameAreaController_1_Easy : MonoBehaviour {
...
//	//
	public void animateGameArea(){
		iTween.MoveTo (GameArea, iTween.Hash ("path", path1, "time", 1f, "easetype", iTween.EaseType.easeInOutQuad, "looptype", iTween.LoopType.none, "delay", 8.398f));
