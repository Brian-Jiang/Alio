...
public class GameAreaController_2_VeryEasy : MonoBehaviour {
...
//		path6 = iTweenPath.GetPath ("GameAreaPath_6");
	...
	public void animateGameArea(){
		iTween.MoveTo (GameArea, iTween.Hash ("path", path1, "time", 2f, "easetype", iTween.EaseType.easeInOutQuad, "looptype", iTween.LoopType.none, "delay", 22.3f));
		iTween.MoveTo (GameArea, iTween.Hash ("path", path2, "time", 30f, "easetype", iTween.EaseType.linear, "looptype", iTween.LoopType.none, "delay", 33.957f));
		iTween.MoveTo (GameArea, iTween.Hash ("path", path3, "time", 11f, "easetype", iTween.EaseType.linear, "looptype", iTween.LoopType.none, "delay", 77.973f));
